 ...
 */
class UserTasksFragment : BaseFragment(), IUserTasksView, androidx.swiperefreshlayout.widget.SwipeRefreshLayout.OnRefreshListener {

    override var layout: Int = R.layout.fragment_item_tasks

    private object Holder { val INSTANCE = UserTasksFragment() }

    companion object {
        val instance: UserTasksFragment by lazy { Holder.INSTANCE }
    }
    ...
    @Inject lateinit var presenter: UserTasksPresenter
